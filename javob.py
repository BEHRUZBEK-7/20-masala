...
# students.add('Aziz')
# print(students)
# remove_result = students.remove('Vali')
# print(students)
# in_result = 'Jamshid' in students
# print(in_result)
# students.add('Jamshid')
# print(students)
# new_students = {'Diyor', 'Vali'}
# students.update(new_students)
# print(students)
# intersection_result = students.intersection({'Ali', 'Diyor', 'Karim'})
# print(intersection_result)
# students.difference({'Aziz', 'Jamshid'})
# print(students)
# graduates = {'Ali', 'Jamshid'}
# students = students.union(graduates)
# print(students)
#4
# numbers = {1, 2, 3, 4}
# numbers.add(5)
...
# print(numbers)
# symmetric_diff = numbers.symmetric_difference({4, 5, 9})
...
# animals.remove('dog')
# print(animals)
# in_result = 'parrot' in animals
# animals.add('parrot')
# print(animals)
# more_animals = {'lion', 'cat'}
# animals.update(more_animals)
# print(animals)
# common_animals = animals.intersection({'cat', 'tiger', 'lion'})
...
# cart.remove('bread')
# print(cart)
# in_result = 'jam' in cart
# print(in_result)
# cart.add('jam')
# print(cart)
# more_items = {'eggs', 'yogurt'}
# cart.update(more_items)
# print(cart)
# expired_items = cart.intersection({'milk', 'eggs', 'ham'})
#7
# subjects = {'Math', 'Physics'}
# in_result = 'Chemistry' in subjects
# print(in_result)
# subjects.add('Chemistry')
# print(subjects)
# subjects.add('Biology')
# print(subjects)
# more_subjects = {'History', 'Math'}
# subjects.update(more_subjects)
# print(subjects)
# common_subjects = subjects.intersection({'Math', 'Geography'})
...
# print(cities)
# in_result = 'Khiva' in cities
# print(in_result)
# cities.add('Khiva')
# print(cities)
# more_cities = {'Andijan', 'Tashkent'}
# cities.update(more_cities)
# print(cities)
# common_cities = cities.intersection({'Tashkent', 'Fergana'})
# print(common_cities)
# cities.discard('Bukhara')
# print(cities)
# print(len(cities))
# print(sorted(cities))
# print(cities)
